package com.kyuhyungympass.job.pass;

import com.kyuhyungympass.repository.pass.*;
import com.kyuhyungympass.repository.user.UserGroupMappingEntity;
import com.kyuhyungympass.repository.user.UserGroupMappingRepository;
...
//        이용권 시작 일시 1일 전 user group 내 각 사용자에게 이용권을 추가해줍니다.
        final LocalDateTime startedAt = LocalDateTime.now().minusDays(1);   // 이용권시작 하루전에 각사용자에게 이용권 지급
        ...
        int count= 0;
//        대량 이용권 정보를 돌면서 user group 에 속한 userId 를 조회하고 해당 userId 로 이용권 추가
