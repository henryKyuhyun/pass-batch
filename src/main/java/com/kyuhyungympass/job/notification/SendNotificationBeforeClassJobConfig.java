...
import com.kyuhyungympass.repository.notification.NotificationEvent;
import com.kyuhyungympass.repository.notification.NotificationModelMapper;
...
//        event 가 수업 전이며 , 발송 여부(sent) 가 미발송인 알람이 조회 대상이된다.
